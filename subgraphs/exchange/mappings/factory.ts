...
import { MoonwalkerFactory, Pair, Token, Bundle } from "../generated/schema";
...
export function handlePairCreated(event: PairCreated): void {
  let factory = MoonwalkerFactory.load(FACTORY_ADDRESS);
  if (factory === null) {
    factory = new MoonwalkerFactory(FACTORY_ADDRESS);
